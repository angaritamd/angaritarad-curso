...
// Los iconos son independientes del idioma; el texto vive en STR.
const ICONOS = [Presentation, Compass, Bot, IdCard, Target, GraduationCap, Radio];

const STR = {
  es: {
    eyebrow: 'Introducción',
    h2: <>Qué es esto,<br /><span style={{ color: 'var(--body)' }}>antes de que entres.</span></>,
    sub: 'Siete cosas que conviene que sepas antes de mirar el catálogo.',
    bloques: [
      {
    ...
    verContenido: 'Ver el contenido',
    solicitarAcceso: 'Solicitar acceso',
  },
  en: {
    eyebrow: 'Introduction',
    h2: <>What this is,<br /><span style={{ color: 'var(--body)' }}>before you go in.</span></>,
    sub: 'Seven things worth knowing before you look at the catalog.',
    bloques: [
      {
        title: "This isn't a slide-deck course",
        body: "I've logged thousands of hours of courses in Colombia and abroad, at the best institutions. The truth: slides and videos aren't enough to make AI actionable in medicine. So I built something different — an agentic course, made by a physician for physicians, where you practice with a real AI agent, not just watch.",
      },
      {
        title: "Don't worry if you've never touched AI",
        body: "You choose the skills based on what you need, in whatever order you want. If you're new, start in order and you won't get lost. Every module opens and closes with a video that tells you exactly what to do. And you can message me directly throughout the course — you're not alone with a machine.",
      },
      {
        title: 'From the first module, a real agent on your WhatsApp',
        body: 'In M1 you activate OpenClaw: an orchestrator agent — an AI system that coordinates several models to execute tasks, not just respond. It lives in your WhatsApp, assists you, and works through tasks with you. You never write code: you talk to it in plain language and it works for you.',
      },
      {
        title: 'Your AI ID, not a certificate',
        body: "You don't leave with a PDF. You leave with an AI ID: your own audited GitHub account, which fills in automatically as you pass quizzes and complete simple tasks. It's real, verifiable evidence that you know how to operate AI — something a certificate can't show.",
      },
      {
        title: 'The course revolves around YOUR topic',
        body: "At the start, you define what part of your field you want to supercharge with AI. The course builds around that, module by module, until by graduation you have nearly a DOI-indexed article. I personally built and verified every module — but the course has a life of its own: depending on your topic and your choices, you end up somewhere different.",
      },
      {
        title: 'The agent signs off on your graduation, not me',
        body: 'In M8, OpenClaw acts as the capstone: it audits your entire progress and turns it into the basis of a DOI-indexed article via Zenodo. The final feedback comes from the agent, not from me. One of a kind.',
      },
      {
        title: 'Live',
        body: 'There are live sessions, on set dates, to answer questions and keep you on pace.',
      },
    ],
    verContenido: 'See the content',
        ...
        <FadeUp delay={0.1}>
          <div style={{ marginTop: 48, display: 'flex', gap: 12, flexWrap: 'wrap', alignItems: 'center' }}>
            <Link to="/contenido" className="btn-brand" style={{ fontSize: 15, padding: '14px 28px' }}>
              {t.verContenido} <ArrowRight size={16} />
            </Link>
